...
namespace WebApiUI.Providers
{
    ...
    public class ApplicationOAuthProvider : OAuthAuthorizationServerProvider
    {
        ...
        public override async Task GrantResourceOwnerCredentials(OAuthGrantResourceOwnerCredentialsContext context)
        {
            ...
            UserBLL user = await userService.FindAsync(context.UserName, context.Password);
            ...
            ClaimsIdentity oAuthIdentity = await userService.GenerateUserIdentityAsync(user,
