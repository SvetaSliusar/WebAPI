...
namespace WebApiUI.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public IUserService UserService
        {
            get
            {
                return _userService ?? Request.GetOwinContext().GetUserManager<IUserService>();
            }
            private set
            {
                _userService = value;
        ...
        {
            UserBLL user = await UserService.FindByIdAsync(User.Identity.GetUserId());
        ...
        public async Task<IHttpActionResult> GetExternalLogin(string provider, string error = null)
        {
            ...
            UserBLL user = await UserService.FindAsync(new UserLoginInfo(externalLogin.LoginProvider,
            ...
            if (hasRegistered)
            {
                ...
                ClaimsIdentity cookieIdentity = await UserService.GenerateUserIdentityAsync(user, CookieAuthenticationDefaults.AuthenticationType);
            ...
            var k = HttpContext.Current.User.Identity.GetUserId<string>();
        ...
        private async Task SetInitialDataAsync()
        {
            ...
            {
                Email = "svetaslusar2@gmail.com",
                UserName = "svetaslusar2@gmail.com",
                Password = "Password1!",
                FirstName = "Sveta",
                LastName = "Sliusar",
                Role = "admin",
